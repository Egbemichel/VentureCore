...
export default function ModidyProject() {
  ...
  return (
    <div className="max-w-lg mx-auto p-6 rounded-md mt-10 ">
      <h1 className="text-[25px] text-[#22c55e] font-bold mb-4">
        Modify Project
      </h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <button
          type="submit"
          disabled={loading}
          className={`bg-[#22c55e] text-white p-2 rounded bottom-0 add-button2 ${
            isZIndexReduced ? "z-0" : "z-10"
          } w-[93%] hover:bg-green-700 transition`}
        >
          {loading ? "Modifying..." : "Modify Project"}
        </button>
      </form>
    </div>
  );
