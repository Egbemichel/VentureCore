...
export default function Post() {
  ...
  return (
    <div className="max-w-lg mx-auto p-6 rounded-md mt-10 ">
      <h1 className="text-[25px] text-[#ef4444] font-bold mb-4">Upload File</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <button
          type="submit"
          disabled={loading}
          className={`bg-[#ef4444] text-white p-2 rounded bottom-0 add-button2 ${
            isZIndexReduced ? "z-0" : "z-10"
          } w-[93%] hover:bg-red-700 transition`}
        >
